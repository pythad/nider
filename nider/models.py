...
from nider.exceptions import AutoGeneratedUnitShadowcolorUsedWarning
    ...
    def _prepare_content(self):
        ...
        for unit in [content.header, content.para, content.linkback]:
            if unit:
                ...
                if not unit.shadowcolor:
                    color_to_use = blend(unit.color, '#000', 0.2)
                    unit.shadowcolor = color_to_use
                    warnings.warn(
                        AutoGeneratedUnitShadowcolorUsedWarning(unit, color_to_use))

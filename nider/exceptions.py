...
class AutoGeneratedUnitShadowcolorUsedWarning(ImageGeneratorWarning):
    def __init__(self, unit, color_used):
        super().__init__(
            "You didn't provide a shadowcolor for {}. Auto generated one('{}') has been used".format(unit.__class__.__name__, color_used))
